...
void profile_matrix_engine_single_core(
...
int main() {
    ...
    try {
        ...
        /* Create source data */
        constexpr uint32_t M = 256;  // user-defined
        constexpr uint32_t N = 256;  // user-defined
        constexpr uint32_t K = 256;  // user-defined
        ...
        profile_matrix_engine_single_core(src0_vec, src1_vec, result_vec, false, M, N, K, B, device);
