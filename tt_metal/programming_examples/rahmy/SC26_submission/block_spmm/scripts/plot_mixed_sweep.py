...
ALGO_COLORS = ["#4472C4", "#ED7D31", "#70AD47"]
...
def main():
    ...
    for case_idx, case in enumerate(CASES):
        ...
        bars = ax.bar(x, values, color=ALGO_COLORS, edgecolor="white", linewidth=0.5, width=0.6)
    ...
    fig.suptitle("Mixed Sweep: Algorithm Throughput Comparison", fontsize=13, y=1.02)
    fig.tight_layout()

    output_path = figures_dir / "mixed_sweep.png"
