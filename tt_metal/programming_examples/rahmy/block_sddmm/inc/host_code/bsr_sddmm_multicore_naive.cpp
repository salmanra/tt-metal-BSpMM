...
void bsr_sddmm_multicore_naive_impl(
    ...
    if constexpr (verbose) {
        log_info(tt::LogVerif, "SDDMM naive: M={} N={} K={} R={} C={}", M, N, K, R, C_block);
    ...
    auto bc_reader_id = tt_metal::CreateKernel(
        program,
        "tt_metal/programming_examples/rahmy/block_sddmm/kernels/dataflow/data_movement_sddmm_BC.cpp",
        all_cores,
    ...
    auto d_writer_id = tt_metal::CreateKernel(
        program,
        "tt_metal/programming_examples/rahmy/block_sddmm/kernels/dataflow/data_movement_sddmm_D_out.cpp",
        all_cores,
        tt_metal::DataMovementConfig{
    ...
    auto compute_id = tt_metal::CreateKernel(
        program,
        "tt_metal/programming_examples/rahmy/block_sddmm/kernels/compute/sddmm_block_multiply.cpp",
        all_cores,
