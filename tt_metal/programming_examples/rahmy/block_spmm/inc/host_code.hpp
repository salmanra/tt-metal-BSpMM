...
// ── Algorithm declarations (3 algorithms) ──

// Naive (load-balanced, new data movement)
...
DECLARE_ABLATION_WRAPPERS(bsr_spmm_multicore_naive)
DECLARE_ABLATION_WRAPPERS(bsr_spmm_multicore_snf_in0_naive_in1)
...
// ── Host Code Registries ──

// Verbose registry (3 algorithms, verbose=true, is_profiling=false)
static std::pair<HostCodeFunctionPtr, std::string> HostCodeRegistryVerbose[] = {
    {bsr_spmm_multicore_naive<true, false>, "bsr_spmm_multicore_naive"},
    {bsr_spmm_multicore_snf_in0_naive_in1<true, false>, "bsr_spmm_multicore_snf_in0_naive_in1"},
    {bsr_spmm_multicore_snf_in0_dda_in1<true, false>, "bsr_spmm_multicore_snf_in0_dda_in1"},
};

// Profiling registry (15 entries: 3 algos x 5 variants)
