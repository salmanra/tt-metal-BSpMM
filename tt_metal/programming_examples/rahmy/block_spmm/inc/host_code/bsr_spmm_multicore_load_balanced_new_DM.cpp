...
void bsr_spmm_multicore_load_balanced_new_DM(
    ...
    bsr_spmm_multicore_load_balanced_new_DM_impl<verbose, is_profiling>(a, b, output, bcast_batch, nnz_blocks, M, N, K, R, C, B, device, {});
}
...
void bsr_spmm_multicore_load_balanced_new_DM_no_a_read(
    ...
    bool bcast_batch, uint32_t nnz_blocks, uint32_t M, uint32_t N, uint32_t K,
    uint32_t R, uint32_t C, uint32_t B, IDevice* device) {
    bsr_spmm_multicore_load_balanced_new_DM_impl<verbose, is_profiling>(a, b, output, bcast_batch, nnz_blocks, M, N, K, R, C, B, device, {{"SKIP_IN0_DRAM_READ", "1"}});
}
template<bool verbose, bool is_profiling>
void bsr_spmm_multicore_load_balanced_new_DM_no_b_read(
    ...
    bool bcast_batch, uint32_t nnz_blocks, uint32_t M, uint32_t N, uint32_t K,
    uint32_t R, uint32_t C, uint32_t B, IDevice* device) {
    bsr_spmm_multicore_load_balanced_new_DM_impl<verbose, is_profiling>(a, b, output, bcast_batch, nnz_blocks, M, N, K, R, C, B, device, {{"SKIP_IN1_DRAM_READ", "1"}});
}
template<bool verbose, bool is_profiling>
void bsr_spmm_multicore_load_balanced_new_DM_no_compute(
    ...
    bool bcast_batch, uint32_t nnz_blocks, uint32_t M, uint32_t N, uint32_t K,
    uint32_t R, uint32_t C, uint32_t B, IDevice* device) {
    bsr_spmm_multicore_load_balanced_new_DM_impl<verbose, is_profiling>(a, b, output, bcast_batch, nnz_blocks, M, N, K, R, C, B, device, {{"SKIP_COMPUTE", "1"}});
}
template<bool verbose, bool is_profiling>
void bsr_spmm_multicore_load_balanced_new_DM_no_write(
    ...
    bool bcast_batch, uint32_t nnz_blocks, uint32_t M, uint32_t N, uint32_t K,
    uint32_t R, uint32_t C, uint32_t B, IDevice* device) {
    bsr_spmm_multicore_load_balanced_new_DM_impl<verbose, is_profiling>(a, b, output, bcast_batch, nnz_blocks, M, N, K, R, C, B, device, {{"SKIP_DRAM_WRITE", "1"}});
}
